...
import java.awt.{ Color, Dimension, FontMetrics, Graphics, Graphics2D,
                  Rectangle, RenderingHints, TexturePaint }
...
class Axis( orient: Int = Axis.HORIZONTAL, private var flagsVar: Int = 0 )
...
//      paintOnTop( g2 )
	...
	private def recalcLabels( g: Graphics ) {
      ...
      val (width, height) = if( orient == HORIZONTAL ) {
//			if( spaceVar.hlog ) {
//				recalcLogLabels
//				return
//			}
